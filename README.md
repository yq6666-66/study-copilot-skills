...
| 36 | ? | ? | `20260914-095010` |
|---|------|----------|------|
| 1 | 408 错题陪练 | `原创变式选择题（LRU vs FIFO）+ 页框推演解析` |
| 2 | 数学一错题陪练 | `双错因各一道设陷阱变式题` |
| 3 | 法考科目配置生成 | `subjects/fakao/profile.json` |
| 4 | 错因聚类分析 | `docs/competition/qwen错因聚类报告.md` |
| 5 | 体验文档 FAQ | `体验说明「常见问题」小节` |
| 6 | 注会科目配置生成 | `subjects/cpa/profile.json` |
| 7 | 原创练习集 01 | `demo-vault/30-知识/原创练习/原创练习集01.md` |
| 8 | 英语一写作练习 | `demo-vault/30-知识/原创练习/英语一写作练习.md` |
| 9 | 代码审查 №1 | `docs/competition/qwen代码审查报告.md` |
| 10 | 本节初稿撰写 | `README「Qwen 使用实录」` |
| 11 | 原创练习集 02 | `demo-vault/30-知识/原创练习/原创练习集02.md` |
| 12 | 政治背诵卡片 | `demo-vault/30-知识/原创练习/政治背诵卡片.md` |
| 13 | 卷种差异对比 | `subjects/kaoyan/卷种差异对比.md` |
| 14 | 错题复测周报 | `demo-vault/20-项目/周报-Qwen.md` |
| 15 | 代码审查 №2（引擎自审） | `docs/competition/qwen代码审查报告2.md` |
| 16 | 新科目接入教程 | `docs/新科目接入教程.md` |
| 17 | qwen3.8-flash 连通验证 | `该型号首次调用` |
| 18 | 代码审查 №3 | `qwen代码审查报告3.md（4 条意见全部采纳落地）` |
| 19 | Skill 提示词优化 | `kaoyan-qwen-drill/SKILL.md 升级版` |
| 20 | 双模型对比 · qwen-flash | `docs/competition/双模型对比报告.md` |
| 21 | 双模型对比 · qwen3.8-flash | `同上（token/输出差异如实记录）` |
| 22 | 下周复测计划表 | `demo-vault/20-项目/复测计划-Qwen.md` |
| 23 | 演示管道全链路 | `scripts/demo_pipeline.py 实跑产出` |
| 24 | 架构文档初稿 | `docs/ARCHITECTURE.md（人工审校删 1 处幻觉）` |
| 25 | CLI 错误文案评审 | `评审建议 3 条采纳 + 抓出埋入的事实错误` |
| 26 | 英文 README 初稿 | `docs/README.en.md（审校修 4 处过时数字）` |
| 27 | 学习周报洞察段 | `docs/competition/学习周报示例.md` |
| 28 | Anki 卡片措辞改写 | `docs/competition/anki导出示例.csv` |
| 29 | 仪表盘摘要 v1 | `学习仪表盘示例.html 首版` |
| 30 | 仪表盘摘要 v2 | `同上（含热点区定稿）` |
| 31 | 考前预练 v1 | `docs/competition/考前预练示例.md` |
| 32 | 考前预练 v2 | `同上（摘录修复后定稿）` |
| 33 | 可行性实跑预练 | `dist/run_demo.py 21 步验证` |
| 34 | 可行性实跑预练 v2 | `同上（幂等修正）` |
| 35 | 考前预练 v3 | `dist/predrill_qwen_demo.md` |
| 36 | demo_pipeline 全链路 v2 | `dist/pipeline_qwen_demo.md` |
