...
def frames_s1():
    ...
    d.text(((W - d.textlength("云端引擎 · 阿里云 Qwen｜16 次真实调用全程留痕", font=F_SMALL)) / 2, 780),
           "云端引擎 · 阿里云 Qwen｜16 次真实调用全程留痕", font=F_SMALL, fill=C_YELLOW)
    yield [img], 2.4
...
def frames_s9():
    ...
    d.text(((W - d.textlength("云端引擎 · 阿里云 Qwen｜16 次真实调用 · logs/qwen/ 全程留痕", font=F_SMALL)) / 2, 790),
           "云端引擎 · 阿里云 Qwen｜16 次真实调用 · logs/qwen/ 全程留痕", font=F_SMALL, fill=C_YELLOW)
    yield [img], 3.0
